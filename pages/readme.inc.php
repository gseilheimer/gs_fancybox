...
<div class="rex-addon-output">
	...
	<div class="rex-addon-content">
		...
		<?php 
			...
			echo $I18N->msg('addon_subpage_readme_txt_01_07') . "<br />";
			echo $I18N->msg('addon_subpage_readme_txt_01_08') . "<br />";
		?>
		</span></code>
		</p>
	</div>	
...
<div class="rex-addon-output">
	...
	<div class="rex-addon-content">
		...
		<?php 
			...
			echo $I18N->msg('addon_subpage_readme_txt_02_08') . "<br />";
		?>
		</span></code>
		</p>
	</div>	
...
<div class="rex-addon-output">
	...
	<div class="rex-addon-content">
		...
		<?php 
			...
			echo $I18N->msg('addon_subpage_readme_txt_05_02') . "<br />";
			echo $I18N->msg('addon_subpage_readme_txt_05_03') . "<br />";
			echo $I18N->msg('addon_subpage_readme_txt_05_04') . "<br />";
			echo $I18N->msg('addon_subpage_readme_txt_05_05') . "<br />";
		?>
		</span></code>
		</p>
	</div>	
